# demo.py
# August 2020
# Demostrate how the processing, extracting, predicting, and breaking all works
#
# source ./venv1/bin/activate
# python3 -W ignore demo.py
...
def main():
    ...
    for img_path in img_paths:
        ...
        decoded_captcha = ""
        # Character have been extracted, now make a prediction for each character
        for (detected_char, actual_char) in zip(detected_chars, actual_chars):
            ...
            if predicted_char == actual_char:
                ...
                color = (0, 0, 255)
            # Process and format the results for output, for the prediction of each character
            ...
            cv2.waitKey(700)
        # Breaking the complete captcha - whether all of the characters were predicted correctly
